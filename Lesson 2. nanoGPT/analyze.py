...
print(f"Weight stats: mean={first_block_key.mean():.4f}, std={first_block_key.std():.4f}")
...
print(f"Potential outliers in first key layer (>3std): {outliers.item()} ({outliers.item()/len(first_block_key)*100:.2f}%)")
